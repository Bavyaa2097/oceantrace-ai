...
export const SpillAnalysisPanel: React.FC<SpillAnalysisPanelProps> = ({
  ...
  return (
    <div className="glass-panel rounded-lg p-4 sm:p-5 border border-[#D9E3E7] space-y-3 flex flex-col justify-between h-full max-h-[580px] overflow-y-auto shadow-sm">
      {/* Header */}
      <div>
        ...
        <div className="mt-3 space-y-1.5 text-xs font-sans">
          ...
          <div className="flex items-center justify-between p-2 rounded bg-white border border-[#D9E3E7]">
            ...
            <span className="text-slate-600 text-[11px]">{spillIncident.detectionTime}</span>
          </div>
          ...
          <div className="flex items-center justify-between p-2 rounded bg-white border border-[#D9E3E7]">
            ...
            <span className="text-[#176b87] text-[11px]">
          ...
          <div className="flex items-center justify-between p-2 rounded bg-white border border-[#D9E3E7]">
            ...
            <span className="text-[10px] text-[#237e73] truncate max-w-[140px]" title={spillIncident.modelUsed}>
        ...
        <div className="mt-3 p-2.5 rounded-lg bg-[#FFF7E6] border border-[#E8C978]">
          <div className="flex items-center justify-between">
            <span className="text-[9px] font-semibold text-[#a66f11] tracking-wide">
              Leading candidate vessel
            </span>
            <span className="text-[9px] px-1.5 py-0.5 rounded bg-[#fff7e6] text-[#a66f11] border border-[#e8c978] font-semibold">
              {topCandidateVessel.overallCorrelation}% MATCH
            </span>
          </div>
          <div className="mt-1.5 flex items-center justify-between">
            <div>
              <div className="font-bold text-[#173b43] text-xs">{topCandidateVessel.name}</div>
              <div className="text-[10px] text-slate-500">MMSI: {topCandidateVessel.mmsi}</div>
            </div>
            <button
